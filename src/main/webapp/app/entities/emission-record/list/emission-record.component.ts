...
import { EntityArrayResponseType, EmissionRecordService } from '../service/emission-record.service';
import { EmissionRecordDeleteDialogComponent } from '../delete/emission-record-delete-dialog.component';

@Component({
  standalone: true,
  selector: 'jhi-emission-record',
...
export class EmissionRecordComponent implements OnInit {
  emissionRecords?: IEmissionRecord[];
  isLoading = false;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.emissionRecords = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmissionRecord[] | null): IEmissionRecord[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.emissionRecordService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
