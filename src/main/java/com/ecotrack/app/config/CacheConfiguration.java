...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ecotrack.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ecotrack.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.ecotrack.app.domain.User.class.getName());
            createCache(cm, com.ecotrack.app.domain.Authority.class.getName());
